class Wave2 extends Phaser.Scene {
    constructor() {
        ...
        this.maxBulletsEn = 2;           // Don't create more than this many bullets
    ...
    create() {
        ...
        // Credit to Jim FixedArrayBullet 
        ...
        // Targets
        my.sprite.target1 = this.add.sprite(this.target1X, this.target1Y, "targets", "duck_target_yellow.png");
        my.sprite.target1.setScale(0.75);
        my.sprite.targets.push(1);      

        my.sprite.target2 = this.add.sprite(this.target2X, this.target2Y, "targets", "duck_target_yellow.png");
        my.sprite.target2.setScale(0.75);
        my.sprite.targets.push(2);      

        my.sprite.target3 = this.add.sprite(this.target3X, this.target3Y, "targets", "duck_target_yellow.png");
        my.sprite.target3.setScale(0.75);
        my.sprite.targets.push(3);

        my.sprite.target4 = this.add.sprite(this.target4X, this.target4Y, "targets", "duck_target_yellow.png");
        my.sprite.target4.setScale(0.75);
        my.sprite.targets.push(4);

        my.sprite.target5 = this.add.sprite(this.target5X, this.target5Y, "targets", "duck_target_yellow.png");
        my.sprite.target5.setScale(0.75);
        my.sprite.targets.push(5);

        my.sprite.target6 = this.add.sprite(this.target6X, this.target6Y, "targets", "duck_target_yellow.png");
        my.sprite.target6.setScale(0.75);
        my.sprite.targets.push(6);

        my.sprite.target7 = this.add.sprite(this.target7X, this.target7Y, "targets", "duck_target_yellow.png");
        my.sprite.target7.setScale(0.75);
        ...
        // Miscellaneous
        document.getElementById('description').innerHTML = '<h2>Wave2.js</h2><br>A or <=: left // D or =>: right // Space: fire/emit';
        ...
        // {
        //     var propertyName = 'target' + (i + 1);
    
        //     // Access the sprite using bracket notation
        //     console.log(my.sprite[propertyName]);
        // } 
    }
    ...
    update() {
        ...
        if (this.RightD.isDown || this.Right.isDown) {
            if (my.sprite.ship.x <= this.width - 210) {
                my.sprite.ship.x += 12;
        ...
        // Movement of targets.
        if (this.rightCountBeg < 3) { // Beginning movement
        ...
        else if (this.leftCount < 6 ){ // Beyond this is the movement of the target until they're destroyed
